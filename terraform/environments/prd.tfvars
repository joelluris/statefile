...
all_resource_groups = {
  rg1 = {
    name = "rg-lnt-eip-aks-prd-uaen-01"
    tags = {
  ...
  rg2 = {
    name = "rg-lnt-eip-vm-prd-uaen-01"
    tags = {
      "Application Owner"    = "IT"
      "Business Criticality" = "Essential"
...
vnets = {
  vn1 = {
    name    = "vnet-lnt-eip-prd-uaen-01"
    rg_name = "rg-lnt-eip-aks-prd-uaen-01"
    cidr    = ["10.5.0.0/20"]
    dns     = ["168.63.129.16"]
    tags = {
      "Application Owner"    = "IT"
    ...
    subnets = {
      sn1 = {
        name               = "snet-lnt-eip-mft-prd-uaen-01"
        cidr               = "10.5.8.64/26"
        service_delegation = ""
      }
      sn2 = {
        name               = "snet-lnt-eip-nd-prd-uaen-01"
        cidr               = "10.5.0.0/24"
        service_delegation = ""
      }
      sn3 = {
        name               = "snet-lnt-eip-privatelink-prd-uaen-01"
        cidr               = "10.5.1.0/24"
        service_delegation = ""
      }
      sn4 = {
        name = "snet-lnt-eip-psql-prd-01"
        cidr = "10.5.7.0/28"
        # service_delegation = "Microsoft.DBforPostgreSQL/flexibleServers" # Comment if not needed
        service_delegation = ""
      }
      sn5 = {
        name               = "snet-lnt-eip-vm-prd-uaen-01"
        cidr               = "10.5.8.0/26"
        service_delegation = ""
      }
    }
  ...
  vn2 = {
    name    = "vnet-lnt-vm-prd-uaen-01"
    rg_name = "rg-lnt-eip-vm-prd-uaen-01"
    cidr    = ["10.6.0.0/20"]
    dns     = ["168.63.129.16"]
    tags = {
      "Application Owner"    = "IT"
...
nsg_snet = {
  snet-lnt-eip-mft-prd-uaen-01 = {
    name      = "snet-lnt-eip-mft-prd-uaen-01"
    rg_name   = "rg-lnt-eip-aks-prd-uaen-01"
    vnet_name = "vnet-lnt-eip-prd-uaen-01"
    snet_name = "snet-lnt-eip-mft-prd-uaen-01"
    tags = {
      "Application Owner"    = "IT"
  ...
  snet-lnt-eip-nd-prd-01 = {
    name      = "snet-lnt-eip-nd-prd-uaen-01"
    rg_name   = "rg-lnt-eip-aks-prd-uaen-01"
    vnet_name = "vnet-lnt-eip-prd-uaen-01"
    snet_name = "snet-lnt-eip-nd-prd-uaen-01"
    tags = {
      "Application Owner"    = "IT"
      "Business Criticality" = "Critical"
      "Environment"          = "Integration"
  ...
  snet-lnt-eip-privatelink-prd-01 = {
    name      = "snet-lnt-eip-privatelink-prd-uaen-01"
    rg_name   = "rg-lnt-eip-aks-prd-uaen-01"
    vnet_name = "vnet-lnt-eip-prd-uaen-01"
    snet_name = "snet-lnt-eip-privatelink-prd-uaen-01"
    tags = {
      "Application Owner"    = "IT"
      "Business Criticality" = "Critical"
      "Environment"          = "Integration"
  ...
  snet-lnt-eip-psql-prd-01 = {
    name      = "snet-lnt-eip-psql-prd-01"
    rg_name   = "rg-lnt-eip-aks-prd-uaen-01"
    vnet_name = "vnet-lnt-eip-prd-uaen-01"
    snet_name = "snet-lnt-eip-psql-prd-01"
    tags = {
      "Application Owner"    = "IT"
      "Business Criticality" = "Critical"
      "Environment"          = "Integration"
  ...
  snet-lnt-eip-vm-prd-uaen-01 = {
    name      = "snet-lnt-eip-vm-prd-uaen-01"
    rg_name   = "rg-lnt-eip-aks-prd-uaen-01"
    vnet_name = "vnet-lnt-eip-prd-uaen-01"
    snet_name = "snet-lnt-eip-vm-prd-uaen-01"
    tags = {
      "Application Owner"    = "IT"
      "Business Criticality" = "Critical"
      "Environment"          = "Integration"
...
vnet_peering_remote = {
  peering1 = {
    ...
    source_vnet_name             = "vnet-lnt-eip-prd-uaen-01"
    remote_vnet_name             = "vnet-hub-uaenorth"
    resource_group_name          = "rg-lnt-eip-aks-prd-uaen-01"
...
storage_accounts = {
  sa1 = {
    resource_group_name        = "rg-lnt-eip-aks-prd-uaen-01"
    location                   = "UAE North"
    storage_account_name       = "stlntprduaen01"
...
key_vault = {
  kv01 = {
    kv_name    = "kv-lnt-prd-uaen-01"
    kv_rg_name = "rg-lnt-eip-aks-prd-uaen-01" # Using rg1
    sku        = "standard"
    tags = {
      "Application Owner"    = "IT"
      "Business Criticality" = "Essential"
...
BackupVault = {
  vault1 = {
    rsv_vault_name          = "rsv-lnt-eip-prd-uaen-01"
    rsv_resource_group_name = "rg-lnt-eip-aks-prd-uaen-01"
    location                = "UAE North"
...
#     rsv_vault_name                 = "rsv-lnt-eip-aks-prd-uaen-01"
#     timezone                       = "UTC"
...
user_assigned_managed_identity = {
  ...
  kubernetes_identity = {
    name     = "kubernetes-lnt-eip-aks-prd-uaen-01"
    rg_name  = "rg-lnt-eip-aks-prd-uaen-01"
    location = "UAE North"
    role_assignments = {
      ra1 = {
        ...
        scope                = "kubelet-lnt-eip-aks-kubelet-prd-uaen-01"
      }
      ra2 = {
        role_definition_name = "Contributor"
        scope_type           = "resource_group"
  ...
  kubelet_identity = {
    name     = "kubelet-lnt-eip-aks-kubelet-prd-uaen-01"
    rg_name  = "rg-lnt-eip-aks-prd-uaen-01"
    location = "UAE North"
    role_assignments = {
      # ra1 = {
